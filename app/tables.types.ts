...
export type PatientContact = {
  ...
  living_with_patient: string;
  pns_approach: string | null;
  contact_listing_decline_reason: string | null;
  consented_contact_listing: string | null;
  reported_test_date: string;
};
